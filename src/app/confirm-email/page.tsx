...
function ConfirmEmailRedirectContent() {
  ...
  useEffect(() => {
    ...
    console.log('Redirecting from /confirm-email to:', redirectUrl);
...
// `/confirm-email` パスから `/verify-email` にリダイレクトするページ
