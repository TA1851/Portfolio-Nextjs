...
const processArticleContent = (article: Article): string => {
  ...
  if (article?.body_html && typeof article.body_html === 'string') {
    ...
    content = content.replace(/<p>([\s\S]*?)```([\s\S]*?)```([\s\S]*?)<\/p>/g, (
...
const ArticleDetailPage: FC = () => {
        ...
        >
          ...
          >
            ...
            >
              <Link
                href="/"
                className="inline-flex items-center px-6 py-3 bg-blue-500
                text-white rounded-lg hover:bg-blue-600 transition-colors font-medium"
              >
                ← ホームに戻る
              </Link>
              <button
                onClick={fetchArticle}
                className="inline-flex items-center px-6 py-3 bg-gray-100
                text-gray-700 rounded-lg hover:bg-gray-200 transition-colors font-medium"
              >
                再試行
              </button>
            </div>
      ...
      >
        ...
        >
          ...
          >
            ...
            <p
              className="text-red-500 mb-8 max-w-md mx-auto"
            >
              {error}
            </p>
            <div
  ...
  return (
    ...
    >
      <div
        className="mx-auto max-w-screen-lg px-4 md:px-8"
      >
        <div
          className="mb-6"
        >
          <Link
            ...
            text-gray-700 rounded hover:bg-gray-200 transition-colors"
          >
            ← ホームに戻る
          </Link>
        </div>
