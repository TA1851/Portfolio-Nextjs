      ...
      <div className="bg-white py-6 sm:py-8 lg:py-12">
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
            ...
            <div className="flex flex-col overflow-hidden rounded-lg border bg-white">
              <Link href="#" className="group relative block h-48 overflow-hidden bg-gray-100">
              </Link>
              <div className="flex flex-1 flex-col p-4 sm:p-6">
              <h3 className="mb-2 text-lg font-semibold text-gray-800">
                <Link href="#" className="transition duration-100 hover:text-indigo-500">
                  ブログ始め方の基本ガイド
                </Link>
              </h3>
            ...
            <div className="flex flex-col overflow-hidden rounded-lg border bg-white">
              ...
              <div className="flex flex-1 flex-col p-4 sm:p-6">
              <h3 className="mb-2 text-lg font-semibold text-gray-800">
                <Link href="#" className="transition duration-100 hover:text-indigo-500">ブログのSEO対策入門</Link>
              </h3>
            ...
            <div className="flex flex-col overflow-hidden rounded-lg border bg-white">
              ...
              <div className="flex flex-1 flex-col p-4 sm:p-6">
              <h3 className="mb-2 text-lg font-semibold text-gray-800">
                <Link href="#" className="transition duration-100 hover:text-indigo-500">読まれるブログの書き方</Link>
              </h3>
