...
function AccountVerificationRedirectContent() {
  ...
  useEffect(() => {
    ...
    console.log('Redirecting from /account-verification to:', redirectUrl);
...
// `/account-verification` パスから `/verify-email` にリダイレクトするページ
export default function AccountVerificationRedirect() {
  return (
    <Suspense fallback={
      ...
      <AccountVerificationRedirectContent />
    </Suspense>
  );
}
