...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('v1 API accessed with:', { token, email, code });
    ...
    if (isDirectBrowserAccess) {
      ...
      console.log('v1 API redirecting browser to frontend verification page:', redirectUrl);
    ...
    console.error('v1 API Proxy error:', error);
    return NextResponse.json(
