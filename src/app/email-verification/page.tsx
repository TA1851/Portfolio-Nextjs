...
function EmailVerificationRedirectContent() {
  ...
  useEffect(() => {
    ...
    console.log('Redirecting from /email-verification to:', redirectUrl);
...
// `/email-verification` パスから `/verify-email` にリダイレクトするページ
export default function EmailVerificationRedirect() {
  return (
    <Suspense fallback={
      ...
      <EmailVerificationRedirectContent />
    </Suspense>
  );
}
