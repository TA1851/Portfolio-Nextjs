...
function VerificationRedirectContent() {
  ...
  useEffect(() => {
    ...
    console.log('Redirecting from /verification to:', redirectUrl);
...
// `/verification` パスから `/verify-email` にリダイレクトするページ
