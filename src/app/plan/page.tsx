      ...
      ">
        ...
        ">
          <h2 className="
            ...
            md:mb-8 lg:text-3xl xl:mb-12
          ">Our plans for you</h2>

          <div className="
            mb-6 
            grid gap-6 
            sm:grid-cols-2 md:mb-8 
          ...
          ">
            ...
            ">
              <div className="mb-12">
                ...
                ">For individuals and organizations who want to try our system</p>
              ...
              ">
                ...
                <a href="#" className="
                  ...
                  hover:bg-gray-300 focus-visible:ring 
            ...
            ">
              <div className="mb-12">
                ...
                <p className="
                  ...
                  mb-8 px-8 
                  text-center text-gray-500
                ">Avanced feaures for Individuals and organizations</p>
            ...
            ">
              <div className="mb-12">
                ...
                <p className="
                  ...
                  mb-8 px-8 
                  text-center text-gray-500
                ">Maximum performace for organisations</p>
          ...
          <div className="
            ...
            sm:text-base
          ">Need help deciding? <a href="#" className="
            text-gray-500 
            underline 
            transition duration-100 
