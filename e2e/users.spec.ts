...
test('login with different user', async ({ page }) => {
  ...
  await page.getByRole('link', { name: 'ログイン' }).click();
  await page.getByRole('textbox', { name: 'Email' }).click();
  await page.getByRole('textbox', { name: 'Email' }).fill('dXXXXXX.com');
  await page.getByRole('textbox', { name: 'Email' }).press('Tab');
  ...
  await page.getByRole('link', { name: 'ログイン画面へ戻る' }).click();
  await page.getByRole('textbox', { name: 'Email' }).click();
  await page.getByRole('textbox', { name: 'Email' }).fill('tXXXXXX.com');
  await page.getByRole('textbox', { name: 'Email' }).press('Tab');
  await page.getByRole('textbox', { name: 'Password' }).fill('tXXXXXXX');
  await page.getByRole('button', { name: 'ログイン' }).click();
  await page.getByRole('button', { name: 'ログアウト' }).click();
});